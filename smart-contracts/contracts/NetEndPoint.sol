...
contract NetEndPoint is IEndPoint, ITicketGranter, EndPointCertData {

    IEmployeeManagment managment;

    constructor(bytes32 _endpoint_id, IEmployeeManagment _managment, uint64 _validity_length) 
        EndPointBase(_endpoint_id) EndPointCertData(_validity_length) {
