...
MY_PN532_HSU::MY_PN532_HSU(HardwareSerial &serial
/* Modified { */
...
int8_t MY_PN532_HSU::writeCommand(const uint8_t *header, uint8_t hlen, const uint8_t *body, uint8_t blen)
{
...
int16_t MY_PN532_HSU::readResponse(uint8_t buf[], uint8_t len, uint16_t timeout)
{
    uint8_t tmp[3];
...
int8_t MY_PN532_HSU::readAckFrame()
{
...
*/
int8_t MY_PN532_HSU::receive(uint8_t *buf, int len, uint16_t timeout)
{
    int read_bytes = 0;
    int ret;
